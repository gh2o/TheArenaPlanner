...
DB.base = {
  ...
  "Science": {
    ...
    "PHYS352B": {
      ...
      "code": "BC", 
      "name": "AP Physics C: Electricity and Magnetism B"
    }, 
    "ENVS350B": {
      "slots": [
        {
      ...
      "code": "BC", 
      "name": "AP Environmental Science B"
    }, 
    "PYSO150B": {
      "slots": [
        {
          "room": "114", 
          "teacher": "Newhouse, Christophe A.", 
          "mod": 0
        }, 
        {
          "room": "114", 
  ...
  "VPA": {
    ...
    "ARTT353B": {
      ...
      "code": "BC", 
      "name": "AP Studio Art: 3-D Design B"
    }, 
    "TECH152B": {
      "slots": [
        {
  ...
  "English": {
    ...
    "EURO101B": {
      ...
      "code": "BC", 
      "name": "Eng/Euro Lit B: Gothic Lit"
    }, 
    "ENGL202B": {
      "slots": [
        {
    ...
    "ELAC307A": {
      ...
      "code": "BC", 
      "name": "AP English Language and Composition 77A"
    }, 
    "ENGL102A": {
      "slots": [
        {
    ...
    "ELAC303A": {
      ...
      "code": "BC", 
      "name": "AP English Language and Composition 73A"
    }, 
    "ENGL102B": {
      "slots": [
        {
    ...
    "ELIC304A": {
      ...
      "code": "BC", 
      "name": "AP English Literature and Composition 84A"
    }, 
    "SHKS100A": {
      "slots": [
        {
    ...
    "ELIC306A": {
      ...
      "code": "BC", 
      "name": "AP English Literature and Composition 86A"
    }, 
    "LPHL100A": {
      "slots": [
        {
    ...
    "ENGL351B": {
      ...
      "code": "BC", 
      "name": "AP English Language and Composition B"
    }, 
    "ELAC302A": {
      "slots": [
        {
      ...
      "code": "BC", 
      "name": "AP English Language and Composition 72A"
    }, 
    "LPHL101A": {
      "slots": [
        {
      ...
      "code": "BC", 
      "name": "Literature & Philosophy: Ethics of Eating"
    }, 
    "EPUB150B": {
      "slots": [
        {
      ...
      "code": "BC", 
      "name": "10th Grade English for Publication"
    }
  }, 
  "Social Studies": {
    "USHI350B": {
      ...
      "code": "BC", 
      "name": "AP United States History B"
    }, 
    "WHST150B": {
      "slots": [
        {
  ...
  "World Lang": {
    ...
    "CHIN350B": {
      ...
      "code": "BC", 
      "name": "AP Chinese Language and Culture B"
    }, 
    "FREN253B": {
      "slots": [
        {
    ...
    "JAPN350B": {
      ...
      "code": "BC", 
      "name": "AP Japanese Language and Culture B"
    }, 
    "HEBW154B": {
      "slots": [
        {
  ...
  "Sp Ed/Other": {
    ...
    "CRPR650B": {
      "slots": [
        {
          "room": "T13", 
          "teacher": "Lavoie, Matthew A.", 
          "mod": 5
        }, 
        {
          "room": "41", 
          "teacher": "Soler, Denise M.", 
          "mod": 7
        }, 
        {
          "room": "T23", 
          "teacher": "Stevenson, Audrey A.", 
          "mod": 7
        }, 
        {
          "room": "T14", 
          "teacher": "Kiramichyan, Tatevik", 
          "mod": 7
        }, 
        {
          "room": "145", 
          "teacher": "Payne, John S.", 
          "mod": 7
        }
      ], 
      "code": "BC", 
      "name": "Career Preparation B"
    }, 
    "CBWK650B": {
      "slots": [
        {
      ...
      "code": "BC", 
      "name": "Community Based Work B"
    }, 
    "ADEM550": {
      "slots": [
        {
          "room": "S103", 
          "teacher": "Puretz, Claire J.", 
          "mod": 5
        }
      ], 
      "code": "BC", 
    ...
    "EURO500B": {
      ...
      "code": "BC", 
      "name": "English/European Literature B"
    }, 
    "CRWK650B": {
      "slots": [
        {
  ...
  "Math": {
    ...
    "ACMA250B": {
      ...
      "code": "BC", 
      "name": "Accelerated Math B Honors"
    }, 
    "PCAL150B": {
      "slots": [
        {
    ...
    "CROB150B": {
      ...
      "code": "BC", 
      "name": "Computers and Robotics Technology B"
    }, 
    "ALGE152A": {
      "slots": [
        {
...
DB.ratings = {
  ...
  "Lo, Winifred": 2.7, 
  "Schwarz, Alexander J.": 3.8, 
  "Liang, Jing": 3.8, 
  "Yoshimura-Lee, Miyuki": 3.7, 
  "Pang, Lani Nahleen": 2.1, 
  "Axt Jr, Milton C.": 3.2, 
  "Cole, Lisa A.": 3.0, 
  "Wenning, Mark Conrad": 3.8, 
  "Recht, Sydney G.": 3.65, 
  "Doherty, Terence Martin": 3.4, 
  "Crabtree, Stephanie I.": 3.3, 
  "Cooley, Bryan A.": 3.25, 
  "Bookwalter, Teresa C.": 3.95, 
  "Moffitt, Jennifer L.": 4.2, 
  "Pollock, John": 1.0, 
  ...
  "Hosoda, Christine S.": 4.0, 
  "Michels, Adam G.": 3.6, 
  "Pollak, Julian Victor": 2.4, 
  "Winter, Michele J.": 4.9, 
  "Starr, David H.": 3.0, 
  "Simon, Arthur D.": 4.25, 
  "Zeeman, David K.": 4.5, 
  "Johnson, Kim D.": 2.75, 
  "Trimble, Michelle": 2.75, 
  "Collins, Gregory P": 3.1, 
  "Rode, Maria T.": 2.65, 
  "Maquinana, Victoria M.": 3.5, 
  "Magsanay, Matthew S.": 3.9, 
  "Johnson, Theodore": 3.6, 
  "Dickerman, Scott I.": 3.8, 
  "Horn, Adee": 3.9, 
  "Swett, Dacotah A.": 2.55, 
  "Gribler, Jeremy L.": 3.05, 
  "Lamarre, Timothy P.": 3.7, 
  "Taylor-Ray, Sascha N.": 4.55, 
  "Christensen, Catherine S.": 4.2, 
  "Melvin, Katherine E.": 3.4, 
  "Chan, Tom C.": 3.85, 
  "Bullard, Doug": 4.75, 
  "Okada, Naomi": 3.2, 
  "Ritter, Bryan A.": 4.25, 
  "Hoffman, Karl E.": 4.2, 
  "Raya, John G.": 3.05, 
  "Credito, Ronilo P.": 4.55, 
  "Freeland, Anne E.": 4.0, 
  "Wagner, Mitchell W.": 1.85, 
  "Johnson, Rebecca L.": 3.85, 
  "Flisak, Maciej": 4.15, 
  "Lipman, David J.": 2.7, 
  "Henares, Nicole N.": 2.75, 
  "Williams, Samuel": 3.6, 
  ...
  "Yu, Samantha H.": 3.4, 
  "Branzburg, Judith Musante": 3.85, 
  "Bellville, Stephanie Michelle": 3.65, 
  "Sinn, Wilson": 4.45, 
  "Santiago, Meredith Chase": 4.5, 
  "Danforth, Brian": 4.5, 
  ...
  "Dean, Sara L.": 3.8, 
  "Geren, Thomas D.": 5.0, 
  "Prophet, Matthew W": 3.6, 
  "Furey, Matthew": 2.95, 
  "Fahey, Patrick J.": 2.65, 
  "Raznikov, Charles": 4.0, 
  "Warshaw, Laurence": 3.75, 
  "Lubenow, Kristin B.": 3.8, 
  "Karapetyan, Lyudmila S.": 3.1, 
  "Steele, William Gabriel": 2.6, 
  "Hereford, David H": 4.85, 
  "Girling, Richard W.": 3.75, 
  "Ray, Robert W": 3.7
};
